...
/**
 * test-all.mjs — Comprehensive test suite for JobHuntAI
 *
...
const systemFiles = [
  ...
  '.claude/skills/JobHuntAI/SKILL.md',
];
...
const leakPatterns = [
  'Author', 'example.com', 'Santifer iRepair', 'Zinkee', 'ALMAS',
  'hello@example.com', '688921377', '/Users/author/',
];
