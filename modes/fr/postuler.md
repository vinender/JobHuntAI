...
5. **JobHuntAI proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/JobHuntAI contacto` pour du LinkedIn outreach vers le hiring manager
