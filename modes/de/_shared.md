# Geteilter Kontext -- JobHuntAI (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle JobHuntAI-Modi
     in der deutschen Variante. Bevor du JobHuntAI verwendest, MUSST du:
