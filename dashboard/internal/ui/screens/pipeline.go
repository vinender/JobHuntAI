...
import (
	...
	"github.com/author/JobHuntAI/dashboard/internal/data"
	"github.com/author/JobHuntAI/dashboard/internal/model"
	"github.com/author/JobHuntAI/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("JobHuntAI by example.com")
